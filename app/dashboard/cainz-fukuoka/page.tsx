...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'cainz-fukuoka'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = 'カインズ福岡'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycbwJYfkrLRUlB1PlFjMZHUMvDtOrSrVLZ7ZEs6E3e1mJCN5wailBwwGXV7syLmZq7dnn/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
