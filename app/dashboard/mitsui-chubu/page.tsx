...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'mitsui-chubu'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = '三井食品'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycbxH3S5J_wLCFM-0Hln-EKVT76yiFX5aT0aoH0wBRd1cPbI530GQhMVb2IHIh38dKziAaA/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
