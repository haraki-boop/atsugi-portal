...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'medi-entrance'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = 'メディエントランス'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycbwpBX4f5aDLO0sFW88ZpQ_tL78JJaNjy0H1Te3NDiKpexEu_ZWipRfBz0p04qvgOTvz/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
