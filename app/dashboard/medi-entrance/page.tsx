...
export default function MediEntranceDashboardPage() {
  // 🚀 メディエントランス専用の locationId に設定
  ...
  const fetchDashboardData = async (isReload = false) => {
    fetchSupabaseData();
    // 🚀 メディエントランス専用のGAS WebアプリURL
    const gasUrl = "https://script.google.com/macros/s/AKfycbw0-zq82X4kA4ou3HzjbCH8U6O7uXGV7LZ3VICnC-jJ4deNQ9YYY-jXeRSuJNy_QUZ91w/exec";
    try {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-20 notranslate print:bg-white print:pb-0 print:block" translate="no">
      ...
      <div className="hidden print:block text-center pt-8 pb-6 border-b-2 border-slate-900 mb-8">
        <h1 className="text-3xl font-black italic tracking-tighter uppercase text-slate-900">経営ダッシュボード : メディエントランス</h1>
