...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'craft-delica'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = 'クラフトデリカ'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycby1euCHkB7_tNs_fEy3PR_CCJCfylAqr-IP3C8FtBTAU_oPcxL7_WdJRvJmh4d5-z9T/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
