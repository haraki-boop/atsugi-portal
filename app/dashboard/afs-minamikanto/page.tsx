...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'afs-minamikanto'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = 'afs南関東'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycbwF8PhNWrNS4bbRbAsvg-rZThmhq99ngwQdoI4Gbm1MH286vM2uiI3Kps6Mykc31_3a/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
