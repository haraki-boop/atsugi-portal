...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'tokyu-store'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = '東急ストア'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycbzFdEySvvgcVBkC6ME2b6-8SH_0fBYn56RfrKbGCJ-EVaXfak2CcutetG83HVkqKeFD/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
