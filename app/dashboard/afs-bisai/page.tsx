...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'afs-bisai'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = 'afs尾西流通'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycby776aOZGzfsa5yH6ogdiX5srR5ZcO8WribNpy71_AeAgFGHT1W_fqOom4XNF0yZ8bkyQ/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
