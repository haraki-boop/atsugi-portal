...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'landport-narashino'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = 'ランドポート'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycbwBoMEc_6mfie1g7eMUEY0hpjo2Yql_FRyKKHs0SidX5q4LyIsLT_fj53BSjwRii8y-/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
