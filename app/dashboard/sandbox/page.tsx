...
export default function MapPortalPage() {
  ...
  return (
    <div className="h-[100dvh] w-screen bg-slate-50 text-slate-900 flex flex-col md:flex-row overflow-hidden font-sans">
      ...
      {/* 🚀 余計なタイル引き伸ばしCSSを全削除し、元の綺麗な状態へ復元 */}
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between px-1">
              ...
              <Link 
                ...
                className="text-slate-300 hover:text-blue-600 transition-colors p-1 rounded-lg hover:bg-slate-50 duration-200"
              >
                <DoorOpen size={14} />
              </Link>
            </div>
