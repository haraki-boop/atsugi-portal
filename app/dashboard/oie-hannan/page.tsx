...
export default function UniversalDashboardPage() {
  ...
  // =========================================================
  const LOCATION_ID = 'oie-hannan'; // ① Supabase用の拠点ID（英数字ハイフン）
  const LOCATION_NAME = '尾家産業'; // ② ヘッダーに表示される現場名
  const GAS_URL = "https://script.google.com/macros/s/AKfycbyB_BevvF7yo5h23J0OYxzGQ6WtbZnkDSs7rROTivhtu2LYIn3AcL_932XevGwfiQtisw/exec"; // ③ 連携するGASのウェブアプリURL
  // =========================================================
